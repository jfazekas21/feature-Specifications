...
| Scene | Trigger |
|---|---|
| **Pre-Game Scene** | Activates before the game begins |
| **In-Game Scene** | Runs throughout the duration of the game |
| **Victory Scene** | Triggers when your team wins |
| **Loss Scene** | Triggers when your team loses |
| **Post-Game Scene** | Activates after the game concludes |
...
| **Score Light Show** | Every time your team scores | Not available for basketball |
...
| Teams supported | Up to 3 | Up to 8 |
| Pre/In-Game/Victory/Loss/Post-Game Scenes | ✅ | ✅ |
| Game Start Light Show | ❌ | ✅ |
| Score Light Show | ❌ | ✅ |
| Team Win Light Show | ❌ | ✅ |
...
*End of Haven Game Day Technology Specification v0.3*